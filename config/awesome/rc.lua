...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioStop", function() sexec("scrot -e 'mv $f ~/Pictures/Screenshots'") end ), --fn - up
   ...
   -- awful.key({"Control", "Mod1"}, "l", function() sexec(commands.lock) end ),
    ...
    awful.key({ modkey }, "x", function ()
     ...
     function (prog)
      sexec(terminal .. " -name " .. prog .. " -e /bin/sh -c " .. prog)
     end)
    end)
)
...
--os.execute("blueman-applet &")
  awful.util.spawn("setxkbmap -model abnt2 -layout br");
